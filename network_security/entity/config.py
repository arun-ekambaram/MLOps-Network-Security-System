...
class DataTransformationConfig:
    def __init__(self,training_pipiline_config: TrainingPipelineConfig):
        self.data_transformation_dir: str = os.path.join(training_pipiline_config.artifact_dir,training_pipeline.Datatra)